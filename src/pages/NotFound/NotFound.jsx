  ...
  return (
    <div className="min-h-[85vh] bg-white flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="relative mb-6 select-none">
        <span className="text-[160px] md:text-[220px] font-black text-[#60804F]/10 leading-none">404</span>
      ...
      <p className="text-slate-400 text-sm md:text-base max-w-sm mb-8">
        Parece que esta página se escapó como un perro sin correa. No la encontramos por ningún lado.
      </p>
